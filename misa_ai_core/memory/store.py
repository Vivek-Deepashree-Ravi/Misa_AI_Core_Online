...
def should_extract_memory(user_text: str, misa_text: str, api_key: str = "") -> bool:
    try:
...
def extract_memory(user_text: str, misa_text: str, api_key: str = "") -> dict:
    try:
        from misa_ai_core.ai.openrouter_gateway import client
        ...
        raw = client.chat(
            ...
            f"- Extract from BOTH user and Misa turns.\n"
